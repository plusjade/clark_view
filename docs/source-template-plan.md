# Source template — completed

Implemented 2026-09-17 in parent main snapshot 357.
...
- [Parent operator procedure](https://www.val.town/x/plusjade/app-clarkview/code/docs/get-sources.md): manual registration, verification, and assignment.
